              ...
              <li >
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" v-bind:class="{'check':1}">
                  ...
                  <div class="cart-item-title">
                    <div class="item-name">111</div>
                  </div>
                </div>
                <div class="cart-tab-2">
                  <div class="item-price">1111</div>
                </div>
                ...
                <div class="cart-tab-4">
                  <div class="item-price-total">500</div>
                </div>
          ...
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                Item total: <span class="total-price">100</span>
              </div>
              <div class="btn-wrap">
